...
class Buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('id_kategoti', 'kategori', 'required', [
        ...
        $this->form_validation->set_rules('tahun_terbir', 'Tahun Terbit', 'required|min_length[3]|max_length[4]|numeric', [
            'required' => 'Tahun terbit harus diisi',
            'min_length' => 'Tahun Terbit terlalu pendek',
            'max_length' => 'Tahun Terbit terlalu panjang',
            'numeric' => 'Hanya Boleh diisi angka'
        ]);
        $this->form_validation->set_rules('isbn', 'Nomer ISBN', 'required|min_length[3]|numeric', [
